# Avax Advanced - Module-1 (Defi Empire, A Simple DeFI Kingdom Clone)
This solidity contract simply replicates the Defi Empire game functionalities
...
Now you can test various functions of the code.
